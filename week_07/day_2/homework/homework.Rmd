...
nyc_bikes_3 %>% 
  ...
  geom_line()
```
This plot shows us that there is a lot more variability within the months than the monthly plot. The fluctuations varie within each which may be due to weather changes, 
